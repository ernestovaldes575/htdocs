...
switch ($DatoList){
	case "01": //Catalogo del Ejercicio  ?>
			<select name="AAreaResp" onChange="CargEjer(this.value)" class="btn-Nuevo">
...
<?php	 break;
	case "02": //Catalogo de Estados ?>
			<select name="EstaDocu" onChange="CargEsta(this.value)" class="btn-Nuevo">
...
<?php	 break;
	case "03": 
				...
				$RutaArch = "/ExpeElectroni/$ClavAyun/$VC04/$VC05/$CarpTiDo/";
		break;
	} // switch ($DatoList){?>		
<?php 