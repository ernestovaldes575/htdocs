...
$ArCook03  = $ConsNoti.'|'.$ArchTrab.'|'.
             $CarpTiDo.'|'.$AnchImag .'|'.$AltoImag .'|'. $TamaImag .'|';
...
$Tipo = '1';
$Ruta = $_SERVER['DOCUMENT_ROOT']."/ExpeElectroni/$ClavAyun/$EjerNoti/$MesTrab/$CarpTiDo/";
$Nomb = $ConsNoti.'_'.$ArchTrab;
$Pagi = '/Intranet/PaginaWeb/BaneLayeNoti/Alta/ImagPagiSalvArch.php';
