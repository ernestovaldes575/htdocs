...
<body> 
	...
	<div class="tabla">
		...
		<div class="botones">
			...
			if($Alta == "A"){ 
				?>
				<a href="Empresa.php?Param1=A&Param2=0" class="nuevo">+Nuevo</a>			
			<?php } ?>
		</div>
			...
			<tbody>
				...
				<tr>
					...
					<td data-titulo="Eliminar: ">
					  <?php if($Baja == "A" ){ ?>
							<a href="Empresa.php?Param1=B&Param2=<?= $VC03?>" class="btn_delete">
							<i class="fa fa-close" aria-hidden="true" title="Eliminar Registro"></i></a>
						<?php } ?>
					</td>
					<td data-titulo="Editar: ">
						<?php if($Modi == "A" ){ ?>
							<a href="Empresa.php?Param1=M&Param2=<?= $VC03?>" class="btn_update">
