...
<form id= "PideDato" name="PideDato" method="post" action="ClienteCRUD.php">
  ...
  <input type="hidden" id="SV01" name="C01" value="M">
  ...
  <table width="48%" class="ListInfo" with="50%">
    <caption>
	  ...
	  <tr>
		...
		<th colspan="2" align="right">
         <a href="/IntraClien/MenuIntranet.php">Regresar</a></th>
	  </tr>	
    </thead>
	<tr>
		<th>No. Anfitrion </th>
	...
	<tr>
		<td></td>
		<td colspan="2" >
			<button type="submit" name="Enviar" placeholder="Actualizar"
					value="M" class="btn-Submit container opacity-50" disabled>
			Actualizar			
			</button>
		</td>
	</tr>	
