            ...
            <ul class="ul">
                ...
                <li class="li">
                    ...
                    <div class="mini desplaza">
                        ...
                        <a class="elemento5" href="/Conac/SRFT/">
                            Sistema de Recursos Federales Transferidos (SRFT)
                        </a>
                        <a class="elemento1" href="/Conac/Cuenta/index.php">
                            Cuenta Pública
                        </a>
                        <a class="elemento4" href="javascript:window.open('/Transparencia/ACUSE%20CUENTA%20PUBLICA%202021.pdf','Acuse de Cuenta Publica','width=600,height=400,left=50,top=50,resizable=yes,scrollbars=yes');void 0">
                            Oficio de la entrega de la cuenta Pública 2021
                        </a>
                        <a class="elemento5" href="/Transparencia/Aviso/aviso_privacidad.php">
                            Aviso de Privacidad
                        </a>
                    </div>
                </li>
