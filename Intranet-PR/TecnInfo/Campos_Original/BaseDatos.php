...
<body>
	...
	?>	
	<!--encabezado-->
	<header> <?php require($_SERVER['DOCUMENT_ROOT'].'/Intranet/Archivos/Files/header.php'); ?> </header>
	<br>
	<div class="tabla">
		...
		<table>
			...
			<tbody>
				<?php foreach ($row as $fila):
					...
					?>
					<tr>
						<td><a href="MenuTabla.php?Param1=<?=$ClavMenu?>&Param2=<?=$DescMenu?>&Param3=<?=$BaseDato?>"><?=$DescMenu?></a></td>
					</tr>
				<?php endforeach ?>
			</tbody>
		</table>
