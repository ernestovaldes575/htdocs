...
<html lang="es">
<head>  
	<title>Fraccion 44AB-Evaluaciones y encuestas a programas financiados con recursos publicos</title>
	...
	<form id="PideDato" method="post" name="formulario" action="InformaCRUD.php">	
		...
		<div class="contenedor-tabla">
			...
			<table class="ListInfo01 tabla">
				...
				<tr>
					<td>Periodo que se informa (Anual)</td>
					<td>
				...
				<tr>
				  <td>Atención: en este campo se mostrará el valor que se agregue al sistema, de acuerdo al valor seleccionado del campo (Período que se informa (Anual))</td>
				  <td><input name="C07" id="VC07" type="text" value="<?=$VC07?>" 
						class="form-control" placeholder="Descripción" ></td>
			  	</tr>
			  	<tr>
				  <td>Denominación del programa evaluado</td>
				  <td><input name="C08" id="VC08" type="text" value="<?=$VC08?>" 
						class="form-control" placeholder="Descripción" ></td>
			  	</tr>
				<tr>
				  <td>Denominación de la evaluación</td>
				  <td><input  name="C09" id="VC09" type="text"value="<?=$VC09?>" 
						class="form-control" placeholder="Descripción" ></td>
			  	</tr>
				<tr>
				  <td>Hipervínculo a los resultados de la evaluación</td>
				  <td>				
				    <?php if ( $TipoMovi == "A" ) { ?>
