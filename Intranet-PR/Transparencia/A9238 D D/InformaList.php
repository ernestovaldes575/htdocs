...
<div class="container table-responsive">
	<table width="70%" class="ListInfo tabla">
		...
		<tr>
			...
			<th>Denominación del Inmueble</th>
			<th>Institución a cargo del Inmueble</th>
			<th colspan="2">
			 <?php 
			   if ($Alta == "A"){ ?>
		...
		<?php 
		  ...
		  foreach($ResuSql as $RegiTabl){
			  $VC03 = $RegiTabl['IIConsecutivo'];
			  $VC04 = $RegiTabl['IITipoInm'];
			  $VC05 = $RegiTabl['IIDenom'];
			  $VC06 = $RegiTabl['IIInstitucion'];
