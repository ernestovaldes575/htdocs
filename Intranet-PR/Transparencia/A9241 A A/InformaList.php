...
<div class="container table-responsive">
	<table width="70%" class="ListInfo tabla">
		...
		<tr>
			...
			<th>Denominación del Mecanismo</th>
			<th>Objetivo(s) del Mecanismo</th>
			<th colspan="2">
			 <?php 
			   if ($Alta == "A"){ ?>
		...
		<?php 
		  ...
		  foreach($ResuSql as $RegiTabl){
			  $VC03 = $RegiTabl['MPConsecutivo'];
			  $VC04 = $RegiTabl['MPPeriodoInf'];
			  $VC05 = $RegiTabl['MPDenom'];
			  $VC06 = $RegiTabl['MPObjetivo'];
