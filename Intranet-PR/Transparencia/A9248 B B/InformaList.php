...
<div class="container table-responsive">
	<table width="70%" class="ListInfo tabla">
		...
		<tr>
			...
			<th>Descripción del Bien donado</th>
			<th>Actividades a las que se destinará</th>
			<th colspan="2">
			 <?php 
			   if ($Alta == "A"){ ?>
		...
		<?php 
		  ...
		  foreach($ResuSql as $RegiTabl){
			  $VC03 = $RegiTabl['DEConsecutivo'];
			  $VC04 = $RegiTabl['DEPerioInf'];
			  $VC05 = $RegiTabl['DEDescrBienDon'];
			  $VC06 = $RegiTabl['DEActivDona'];
