<!DOCTYPE html>
    ...
    { 	//Bandera de visualizar msg
		...
		$RevisarS= ""; $RevisarN= ""; 	
		switch( $VC17 ) {
			case "P": $RevisarN = "checked"; 	break;
			case "T": $RevisarS = "checked";	break;
		}	
		?>
		...
		<div class="principal">
			...
			<form method="post" name="formulario" onsubmit="return validar(this)">
				...
				<table >
					...
					<tr>
						<th>Dejar de Publicar</td>
						<td><?=$VC17?>
							<input type="checkbox" name="C04" value="S" <?=$RevisarS?>> Si
							&nbsp;&nbsp;
							<input type="checkbox" name="C04" value="N" <?=$RevisarN?>> No
