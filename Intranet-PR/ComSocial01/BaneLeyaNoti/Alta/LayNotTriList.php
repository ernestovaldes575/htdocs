...
<body> 
	...
	$InstSql =  "SELECT LConsecut,LEjercicio,LMesRegi,". 
					   ...
					   "RTRIM(LArchDocu), RTRIM(LImagColo), ". 
					   "RTRIM(LImagBlan), RTRIM(LSenaSord), ". 
	...
	<div class="tabla">
		...
		<div class="botones">
			...
			&nbsp;&nbsp;
			<input type="checkbox" name="C06" value="T" onChange="CargaEsta('T')" <?=$EstaRevT?>> Termino de la Publ
			...
			if($Alta == "A"){ 
				?>
				<a href="LayNotTri.php?Param1=A&Param2=0" class="nuevo">+Nuevo</a>			
			<?php } ?>
		</div>
