...
{ case "GET": 
		...
		if( isset($_GET['PaAMB01']) != ''){	
			...
			$InstSql =  "SELECT PEjercicio,PMesRegi,". 
								...
								"PVentRefe, PEstaSegu, CTDCarpeta ".
						"FROM  PTPagina ".
			...
			if ($ResuSql){ 
				...
				$VC12 = $ResuSql['CTDCarpeta']; //Carpeta
			}
			
			$RutaArch = "/ExpeElectroni/$ClavAyun/$EjerTrab/$MesTrab/$VC12/";
			//-----------------------------------------------------------  	
	...
	case "POST": //Alta
		...
		$ArchMost = "N";
		$DondAbri = "N";
		if($TipoDocu == "02" || $TipoDocu == "03" || $TipoDocu == "04"){
			$ArchMost = "I"; //Imagen
			$DondAbri = "V"; //Ventana
		}
