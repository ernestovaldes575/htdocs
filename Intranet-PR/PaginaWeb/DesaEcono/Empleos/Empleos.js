...
function (event) { 
  if (event.target.classList.contains('Nuev')) {
      ...
      window.location.href = 'Boletin.php?PaCRUD01=A&PaCRUD02=0';
    }
    ...
    window.location.href = 'Boletin.php?PaCRUD01=M&PaCRUD02='+id; 
 } 
  ...
  if (confirm('¿Estás seguro de que deseas eliminar el registro?')) 
     window.location.href = 'Boletin.php?PaCRUD01=B&PaCRUD02='+id;
 }    
});

//Carga Imagen
function CargImag01(Param1)
{ Ruta = "BoletinSubiArch.php?Param1="+Param1; 
