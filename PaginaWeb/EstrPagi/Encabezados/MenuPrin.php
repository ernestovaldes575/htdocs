<header class="header">
    <div class="contenedor__principal navegacion">
        <a href="" class="a">
            <img src="/PaguinaWeb/img/logo/LOGO-PRINCIPAL.png" class="escudo_mur" alt="Logo">
        </a>
        ...
        <a href="" class="a">
            <img src="/PaguinaWeb/img/logo/escudo.png" class="escudo animate" alt="Logo">
        </a>
    </div>
</header>
<div class="nav__secondary punchline">
    <div class="contenedor__barra">
        <img class="barra" src="/PaguinaWeb/img/logo/BARRA.png" alt="">
    </div>
</div>
