    <main class="contenedor">
        <div class="contenedor-centrar">
            <div class="aviso-grid" >
                    ...
                    <div class="swiper" id="swiper-3">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <a href="<?=$InicHtml?>">
                                    <img src="<?=$ImagPagi?>" alt="Imagenes de Aviso">
                                </a>
                            </div>
                            <?php
                            }
                ...
                <article>
                    <div class="swiper" id="swiper-5">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <a href="">
                                    <img src="/PaguinaWeb/img/Interes/conmutador.png" alt="conmutador">
                                </a> 
                            </div>
                            <div class="swiper-slide">
                                <a href="">
                                    <img src="/PaguinaWeb/img/Interes/conmutador.png" alt="">
                                </a> 
                            </div>
                            <div class="swiper-slide">
                                <a href="">
                ...
                <article">
                    <div>
                        <img src="/PaguinaWeb/img/tel2.png" alt="">
                    </div>
                    <div class="swiper" id="swiper-4">
                        <!-- Imagenes Inicio -->
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <a href=""><img src="/PaguinaWeb/img/busq/1.jpg" alt=""></a> 
                            </div>
                            <div class="swiper-slide">
                                <a href=""><img src="/PaguinaWeb/img/busq/2.jpg" alt=""></a> 
                            </div>
                            <div class="swiper-slide">
                                <a href=""><img src="/PaguinaWeb/img/busq/1.jpg" alt=""></a> 
                            </div>
