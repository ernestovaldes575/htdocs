...
function printCSSlibs($libs){
    ...
    $cnt=$cnt.((isset($libs["cabildo"]))?'<link href="cabildo.css" rel="stylesheet">':'');
    $cnt=$cnt.((isset($libs["dir"]))?'<link href="dir.css" rel="stylesheet">':'');
    $cnt=$cnt.((isset($libs["vcabildos"]))?'<link href="vcabildos.css" rel="stylesheet">':'');
    $cnt=$cnt.((isset($libs["normatividad"]))?'<link href="normatividad.css" rel="stylesheet">':'');
    echo $cnt;
}
