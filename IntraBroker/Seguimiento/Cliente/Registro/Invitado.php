...
<head>  
	<?php
	$TituEnca = "Invitado";
	include $_SERVER['DOCUMENT_ROOT'].'/IntraClien/Encabezado/EncaLiga.php';
	?>
</head>	
...
<header>
 <?php 
    require_once($_SERVER['DOCUMENT_ROOT'].'/IntraClien/Encabezado/EncaCook.php'); 
    //Encabezado	
    require_once($_SERVER['DOCUMENT_ROOT'].'/IntraClien/Encabezado/EncaPrin.php'); 
  ?>
 </header>
<?php 
...
$RegrPagi = ( $TipoMovi == "A") ? "Anfitrion.php":"/IntraClien/MenuIntranet.php"; 
...
<script src="/IntraClien/js/ValiForm.js"></script>
</body>
</html>