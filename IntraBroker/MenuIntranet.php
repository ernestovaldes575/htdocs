...
<?php
$ClavAyun = '105';
include($_SERVER['DOCUMENT_ROOT'].'/IntraBroker/Encabezado/EncaCook.php'); 
...
<table>
	<?php 
	 	//	foreach($MenuBase as $valor):
			...
			$CMEDescri = 'Broker';	//$valor['CMEDescri'];
	...
	<a href="/IntraBroker/Intranet.php" class="enlace1 exit">Salir</a>
</body>
</html>
