...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-05-2024 a las 01:02:53
...
(1, '000001', '000001', '105', 'Horacio Reyes Ramirez', '48', 'A'),
...
(1, '105', '04682', 'O', 'Horacio', 'Reyes', 'Ramirez', 48, 'Ingeniero', 'hh', '2021-11-16', '2021-12-01', '2021-11-25', 1),
...
--
-- Indices de la tabla `atacceso`
--
ALTER TABLE `atacceso`
  ADD PRIMARY KEY (`AConsecut`);
