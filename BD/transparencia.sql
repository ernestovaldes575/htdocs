...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-07-2024 a las 22:57:21
...
(9, '105', 2024, 48, '92', '01', '', 'T', -1, -1, -1, -1),
(10, '105', 2024, 48, '92', '03', '', 'T', -1, -1, -1, -1);
...
--
-- Estructura de tabla para la tabla `ttfraccion01`
--

CREATE TABLE `ttfraccion01` (
  `FFraccion` int(2) DEFAULT NULL,
  `FInciso` int(2) DEFAULT NULL,
  `FSubinciso` varchar(4) CHARACTER SET utf8 DEFAULT NULL,
...
--
-- Volcado de datos para la tabla `ttfraccion01`
--

INSERT INTO `ttfraccion01` (`FFraccion`, `FInciso`, `FSubinciso`, `FNormatividad`, `FPeriodo`, `FSalida`) VALUES
...
--
-- Indices de la tabla `ttfraccion`
--
ALTER TABLE `ttfraccion`
  ADD PRIMARY KEY (`FFraccion`,`FInciso`,`FSubinciso`);
...
--
ALTER TABLE `ttfracarea`
  MODIFY `FAConsecutivo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
COMMIT;
