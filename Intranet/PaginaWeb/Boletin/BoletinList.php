...
<body>
<script language="JavaScript" src="Boletin.js"></script>	
<header>
<?php 
  //Varibales Globales
...
<table class="ListInfo">
  ...
  <tbody>
	...
	foreach ($ListSupe as $RegiTabl): 
		    $VC03=$RegiTabl['BConsecut'];
			$VC04=$RegiTabl['BPersoExtra'];
			$VC05=$RegiTabl['BFechExtra'];
			$VC06=$RegiTabl['BFoto'];
			$RutaArch = '/ExpeElectroni/'.$ClavAyun.'/'.$EjerTrab.'/BoleExtr/'.$VC06;
	?>
	<tr>
		<td><?=$VC04?></td>				<!--Cambiar-->
		<td><?=$VC05?></td>				<!--Cambiar-->
		<td><?=$VC06?></td>				<!--Cambiar-->
		<td>
		  <a href="#" onclick="CargImag01(<?= $VC03?>)">
		  Doc</a>
		<? if ( $VC10 != "" ) { ?>
