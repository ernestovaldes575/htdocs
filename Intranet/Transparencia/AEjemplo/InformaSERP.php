...
if (isset($_GET['PaAMB01']) && $_GET['PaAMB01'] != '') {
...
// Consulta para cargar el registro para Consulta
$InstSql = "SELECT ANumeRegi, AFechaInicio, AFechaTermino, AArea, ADenominacion, AFunadamento, AHipervinculo, AAreaRespon, ANota ".
           "FROM tt9203facare ".
           "WHERE AAyuntamiento = '$ClavAyun' AND AEjercicio = $EjerTrab AND AConsecutivo = $CampBusq ";
...
try {
    ...
    if ($ResuSql) {
        ...
        // Si no se encontró ningún registro, busca el siguiente
