	...
	<form id="PideDato" method="post" name="formulario" action="InformaCRUD.php">	
		...
		<div class="contenedor-tabla">
			...
			<table class="ListInfo01 tabla">
				...
				<tr>
					<td>Período que se informa (Anual)</td>
					<td>
				...
				<tr>
				  <td>atención: en este campo se mostrará el valor que se agregue al sistema, de acuerdo al valor seleccionado del campo (Período que se informa (Anual)), para los criterios fecha de inicio y termino del período que se informa</td>
				...
				<tr>
				  <td>Denominación de la encuesta</td>
			  ...
			  <tr>
				  <td>Hipervínculo a los resultados de las encuestas</td>
				  <td>				
				    <?php if ( $TipoMovi == "A" ) { ?>
