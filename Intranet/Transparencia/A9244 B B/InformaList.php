...
<?=$NumeInci?>
		...
		<th>No</th>
			<th>Período que se informa (Anual)</th>
			<th >atención: en este campo se mostrará el valor que se agregue al sistema, de acuerdo al valor seleccionado del campo (Período que se informa (Anual)), para los criterios fecha de inicio y termino del período que se informa</th>
