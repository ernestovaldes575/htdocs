...
<html lang="es">
<head>  
	<title>Fraccion 37-Convenios de coordinacion</title>
	...
	<form id="PideDato" method="post" name="formulario" action="InformaCRUD.php">	
		...
		<div class="contenedor-tabla">
			...
			<table class="ListInfo01 tabla">
				...
				<tr>
        			<td>Hipervinculo al documento con modificaciones </td>
					<td>				
				    <?php if ( $TipoMovi == "A" ) { ?>
					    Registrar la información para realizar el hipervinculo 
					<?php } else { ?>
						...
						<?php 
	 					   if ( $VC20 != '' ) { ?> 
							<a href="javascript:window.open('<?=$RutaArch.$VC20?>','','width=600,height=400,left=50,top=50,resizable=yes,scrollbars=yes');void 0">
							<i class="bi bi-eye-fill fs-1 text-success"></i>
						<?php  echo "</a> "; } 
						} //} else {?>
				  </td>				
