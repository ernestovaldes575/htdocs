...
switch ( $CRUD )
{ 	case "POST": //Alta
		$InstSql = "INSERT INTO tta9241b ".						//Cambiar tabla
		...
		break;
	case "PUT": //Cambio
		$InstSql = 	"UPDATE tta9241b ". //Cambiar tabla ANumeRegi, ,".
	 
				"SET    ANumeRegi = '$VC05',".
						"APeriodoInforma = '$VC06',".	
						"APeriodoInformaOtro = '$VC07',".				
						"ADenomiParticipacion = '$VC08',".				
				   		"AResultados = '$VC09',".			
						"ANumeroParticipantes = '$VC10',".  
						"ARespuestaSujeto = '$VC11',".			
						"AAreaResp = '$VC12',".
						"ANota = '$VC13' ".
	...
	case "DELETE": //Eliminar
		$InstSql = "DELETE FROM tta9241b ". 					//Cambiar tabla
