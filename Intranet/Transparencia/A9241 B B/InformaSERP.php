...
$InstSql = 	"SELECT ANumeRegi, APeriodoInforma,".
                    "APeriodoInformaOtro, ADenomiParticipacion,".
                    "AResultados, ANumeroParticipantes,".
                    "ARespuestaSujeto, AAreaResp, ANota ".
...
if ($ResuSql)
 { //Carga los campos 
   ...
   $VC08 = $ResuSql['ADenomiParticipacion'];
   $VC09 = $ResuSql['AResultados'];
   $VC10 = $ResuSql['ANumeroParticipantes'];
   $VC11 = $ResuSql['ARespuestaSujeto'];
