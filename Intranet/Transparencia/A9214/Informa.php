		...
		<div class="contenedor-tabla">
			...
			<table class="ListInfo01 tabla">
				...
				<tr>
        			...
        			<td><input type="date" name="C19" id="VC19" value="<?=$VC19?>"></td>
      			</tr>
				<tr>
        			<td>Fecha termino de vigencia </td>				
        			<td><input type="date" name="C20" id="VC20" value="<?=$VC20?>"></td>
      			</tr>
				<tr>
        			<td>Diseño </td>				
				...
				<tr>
        			...
        			<td><input type="text" name="C29" id="VC29" value="<?=$VC29?>"></td>
      			</tr>
				<tr>
        			<td>Hipervinculo documento de modificadiones </td>				
        			<td><input type="text" name="C30" id="VC30" value="<?=$VC30?>"></td>
      			</tr>
				<tr>
        			<td>Hipervinculo calendario presupuestal </td>				
        			<td><input type="text" name="C31" id="VC31" value="<?=$VC31?>"></td>
      			</tr>
				  <tr>
        			<td>Criterios de elegibilidad </td>				
        			<td><input type="text" name="C32" id="VC32" value="<?=$VC32?>"></td>
      			</tr>
				<tr>
        			<td>Requisitos y procedimiento de acceso </td>				
        			<td><input type="text" name="C33" id="VC33" value="<?=$VC33?>"></td>
      			</tr>
				<tr>
        			<td>Monto minimo que recibirá </td>				
        			<td><input type="text" name="C34" id="VC34" value="<?=$VC34?>"></td>
      			</tr>
				<tr>
        			<td>Monto maximo que recibirá </td>				
        			<td><input type="text" name="C35" id="VC35" value="<?=$VC35?>"></td>
      			</tr>
				<tr>
        			<td>Procedimientos de queja </td>				
        			<td><input type="text" name="C36" id="VC36" value="<?=$VC36?>"></td>
      			</tr>
				<tr>
        			<td>Mecanismo de exigibilidad </td>				
        			<td><input type="text" name="C37" id="VC37" value="<?=$VC37?>"></td>
      			</tr>
				  <tr>
        			<td>Mecanismos de cancelacion </td>				
        			<td><input type="text" name="C38" id="VC38" value="<?=$VC38?>"></td>
      			</tr>
				<tr>
        			<td>Periodo evaluado </td>				
        			<td><input type="text" name="C39" id="VC39" value="<?=$VC39?>"></td>
      			</tr>
				<tr>
        			<td>Mecanismos de evaluacion </td>				
        			<td><input type="text" name="C40" id="VC40" value="<?=$VC40?>"></td>
      			</tr>
				  <tr>
        			<td>Instancia evaluadora </td>				
        			<td><input type="text" name="C41" id="VC41" value="<?=$VC41?>"></td>
      			</tr>
				<tr>
        			<td>Hipervinculo a resultados de informe </td>				
        			<td><input type="text" name="C42" id="VC42" value="<?=$VC42?>"></td>
      			</tr>
				<tr>
        			<td>Seguimiento de recomendaciones</td>				
        			<td><input type="text" name="C43" id="VC43" value="<?=$VC43?>"></td>
      			</tr>
				<tr>
        			<td>Indicador </td>				
        			<td><input type="text" name="C44" id="VC44" value="<?=$VC44?>"></td>
      			</tr>
				<tr>
        			<td>Forma de participacion social </td>				
        			<td><input type="text" name="C45" id="VC45" value="<?=$VC45?>"></td>
      			</tr>
				  <tr>
        			<td>Articulacion con otro programa (si/no) </td>				
        			<td><input type="text" name="C46" id="VC46" value="<?=$VC46?>"></td>
      			</tr>
				  <tr>
        			<td>Articulacion con otro programa social (otro) </td>				
        			<td><input type="text" name="C47" id="VC47" value="<?=$VC47?>"></td>
      			</tr>
				<tr>
        			<td>Denominacion del programa </td>				
        			<td><input type="text" name="C48" id="VC48" value="<?=$VC48?>"></td>
      			</tr>
				<tr>
        			<td>Esta sujeto a reglas de operacion (si/no) </td>				
        			<td><input type="text" name="C49" id="VC49" value="<?=$VC49?>"></td>
      			</tr>
				  <tr>
        			<td>Esta sujeto a reglas de operacion (otro) </td>				
        			<td><input type="text" name="C50" id="VC50" value="<?=$VC50?>"></td>
      			</tr>
				<tr>
        			<td>Hipervinculo Reglas de operacion </td>				
        			<td><input type="text" name="C51" id="VC51" value="<?=$VC51?>"></td>
      			</tr>
				<tr>
        			<td>Informes periodicos de ejecucion de programa </td>				
        			<td><input type="text" name="C52" id="VC52" value="<?=$VC52?>"></td>
      			</tr>
				  <tr>
        			<td>Hipervinculo Padron de beneficiarios </td>				
        			<td><input type="text" name="C53" id="VC53" value="<?=$VC53?>"></td>
      			</tr>
				  <tr>
        			<td>Area responsable de informacion </td>				
        			<td><input type="text" name="C54" id="VC54" value="<?=$VC54?>"></td>
      			</tr>
				  <tr>
        			<td>Fecha de validacion </td>				
        			<td><input type="date" name="C55" id="VC55" value="<?=$VC55?>"></td>
      			</tr>
				<tr>
        			<td>Fecha de actualizacion </td>				
        			<td><input type="date" name="C56" id="VC56" value="<?=$VC56?>"></td>
      			</tr>
				  <tr>
        			<td>Nota </td>				
        			<td><input type="text" name="C57" id="VC57" value="<?=$VC57?>"></td>
      			</tr>
