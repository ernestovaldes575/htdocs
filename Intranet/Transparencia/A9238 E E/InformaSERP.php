...
$InstSql = 	"SELECT ANumeRegi, APeriodoInforma,".
                    "APeriodoInformaOtro, ADescripcionBien,".
                    "ACausaAlta, AFechaAlta, AValorInmueble,".
                    "AAreaResp, ANota ".
...
if ($ResuSql)
 { //Carga los campos  
   ...
   $VC08 = $ResuSql['ADescripcionBien'];
   $VC09 = $ResuSql['ACausaAlta'];
   $VC10 = $ResuSql['AFechaAlta'];
   $VC11 = $ResuSql['AValorInmueble'];
