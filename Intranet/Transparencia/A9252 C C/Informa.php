	...
	<form id="PideDato" method="post" name="formulario" action="InformaCRUD.php">	
		...
		<div class="contenedor-tabla">
			...
			<table class="ListInfo01 tabla">
				...
				<tr>
					<td>Periodo Informacion (Otro)</td>
					<td>
				...
				<tr>
				  <td>Hipervínculo Información</td>
				  <td>				
				    <?php if ( $TipoMovi == "A" ) { ?>
					...
					<?php } else { ?>
						...
						<?php 
	 					   if ( $VC08 != '' ) { ?> 
							<a href="javascript:window.open('<?=$RutaArch.$V08?>','','width=600,height=400,left=50,top=50,resizable=yes,scrollbars=yes');void 0">
				...
				<tr>
				  ...
				  <?php 
        			...
        			<!-- <td><input type="number" name="C36" id="VC36" value="<?=$VC09?>" class="form-control" placeholder="Descripción"></td> -->
      			</tr>
				<tr>
				  <td>Nota</td>
