...
<html lang="es">
<head>  
	<title>Fraccion 52B-Preguntas Frecuentes</title>
	...
	<form id="PideDato" method="post" name="formulario" action="InformaCRUD.php">	
		...
		<div class="contenedor-tabla">
			...
			<table class="ListInfo01 tabla">
				...
				<tr>
        			<td>Tématica de las preguntas frecuentes</td>				
				...
				<tr>
        			<td>Respuesta a cada una de las pregunts plateadas</td>				
        			<td><input type="text" name="C10" id="VC10" value="<?=$VC10?>" class="form-control" placeholder="Descripción"></td>
      			</tr>
				<tr>
        			<td>Hipervinculo al Informe Estadístico</td>	
					<td>						
				    <?php if ( $TipoMovi == "A" ) { ?>
				...
				<tr>
        			<td>Número total de Preguntas realizadas por las personas al sujeto obligado</td>				
