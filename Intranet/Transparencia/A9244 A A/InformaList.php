...
<html lang="es">
<head> 
	<title>Fraccion 44AB-Evaluaciones y encuestas a programas financiados</title>
...
<div class="container table-responsive">
	<table width="70%" class="ListInfo tabla">
		...
		<tr>
			<th>No</th>
			<th>Periodo que se informa</th>
			<th>Denominación del programa evaluado</th>
			<th>Denominación de la evaluación</th>
			<th colspan="2">
			 <?php 
			   if ($Alta == "A"){ ?>
		...
		<?php 
		  ...
		  foreach($ResuSql as $RegiTabl){
			  $VC03 = $RegiTabl['EEConsecutivo'];
			  $VC04 = $RegiTabl['EEPeriodInf'];
			  $VC05 = $RegiTabl['EEDenomProg'];
			  $VC06 = $RegiTabl['EEDenomEval'];
