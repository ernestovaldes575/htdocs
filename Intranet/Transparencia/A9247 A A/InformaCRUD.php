...
switch ( $CRUD )
{ 	case "POST": //Alta
		$InstSql = "INSERT INTO tta9247a ".						//Cambiar tabla
		...
		break;
	case "PUT": //Cambio
		$InstSql = 	"UPDATE tta9247a ". 	//Cambiar tabla
		
					"SET    ANumeRegi = $VC05,". 					
						   "APeriodoInforma = '$VC06',".				
						   "APeriodoInformaOtro = '$VC07',".				
						   "AConceptoIngresos = '$VC08',".						
						   "ATipoIngresos = '$VC09',".				
						   "AMontoIngresosConcepto = '$VC10',".				
						   "AFuenteIngresos = '$VC11',".				
				   		   "ADenominacionEntidad = '$VC12',".
						   "AFechaIngresos = '$VC13',".						
						   "AHiperInformes = '$VC14',".				
						   "AAreaResp = '$VC15',".				
						   "ANota = '$VC16' ".				
	...
	case "DELETE": //Eliminar
		$InstSql = "DELETE FROM tta9247a ". 					//Cambiar tabla
				   "WHERE AAyuntamiento = '$ClavAyun' AND ".		//Cambiar campo
						  "AEjercicio = $EjerTrab AND ".			//Cambiar campo
				  		  "AConsecutivo = $CampBusq ";			//Cambiar campo
