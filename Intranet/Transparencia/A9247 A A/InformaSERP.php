...
$InstSql = 	"SELECT ANumeRegi, APeriodoInforma,". 
                   "APeriodoInformaOtro, AConceptoIngresos,".
                   "ATipoIngresos, AMontoIngresosConcepto,".
                   "AFuenteIngresos, ADenominacionEntidad,".
                   "AFechaIngresos, AHiperInformes, AAreaResp, ANota ".
...
if ($ResuSql)
 { //Carga los campos 
   ...
   $VC08 = $ResuSql['AConceptoIngresos'];
   $VC09 = $ResuSql['ATipoIngresos'];
   $VC10 = $ResuSql['AMontoIngresosConcepto'];
   $VC11 = $ResuSql['AFuenteIngresos'];
   $VC12 = $ResuSql['ADenominacionEntidad'];	
   $VC13 = $ResuSql['AFechaIngresos'];		
   $VC14 = $ResuSql['AHiperInformes'];
   $VC15 = $ResuSql['AAreaResp'];
   $VC16 = $ResuSql['ANota'];
