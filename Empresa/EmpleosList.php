...
<br>
<div class="tabla">
	<div class="titulo"><h2>Bolsa de Trabajo</h2></div>
	<div class="botones">
	  <a href="Intranet.php" class="regresar">Regresar</a>
	  <?=$NombEmpr?>
	  <a href="Empresa.php?Param1=M&Param2=<?=$ConsEmpr?>" class="nuevo">+Modificar</a>
