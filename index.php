...
<head>
    <?php
        $ClavAyun = '105';
        $Titulo = "Zinacantepec";
        include 'PaginaWeb/EstrPagi/Encabezados/HeadHtml.php';
    ?>
</head>
<body>
    <?php
        include 'PaginaWeb/EstrPagi/Encabezados/MenuPrin.php';
        include 'PaginaWeb/EstrPagi/Encabezados/RedesSociales.php';
    ?>
